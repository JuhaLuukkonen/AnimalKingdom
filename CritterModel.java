...
public class CritterModel {
    ...
    public CritterModel(int width, int height) {
        // tämä estää kopion tekemistä GUI komponentista
        if (created)
    ...
    public String getAppearance(Critter c) {
        // Ylikirjoittaa määritellyn toString jos debug lippu on tosi
        if (!debugView) 
            return info.get(c).string;
        else {
    ...
    // palauttaa tuloksen rotaaion annettu suunta myötäpäivään
